            ...
            <ul class="ml-auto flex items-center">
                            ...
                            <ul class="max-h-64 overflow-y-auto" data-tab-for="notification" data-page="notifications">
                                <li>
                                    <a href="#" class="py-2 px-4 flex items-center hover:bg-gray-50 group">
                                        ...
                                        <div class="ml-2">
                                            <div class="text-[13px] text-gray-600 font-medium truncate group-hover:text-blue-500">Nghỉ lễ 30/4, 1/5</div>
                                            <div class="text-[11px] text-gray-400">ĐH Công thương</div>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <li>
                                    <a href="#" class="py-2 px-4 flex items-center hover:bg-gray-50 group">
                                        ...
                                        <div class="ml-2">
                                            ...
                                            <div class="text-[11px] text-gray-400">Nghỉ phép</div>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="py-2 px-4 flex items-center hover:bg-gray-50 group">
                                        <img src="https://placehold.co/32x32" alt="" class="w-8 h-8 rounded block object-cover align-middle">
                                        <div class="ml-2">
                                            <div class="text-[13px] text-gray-600 font-medium truncate group-hover:text-blue-500">Khoa CNTT</div>
                                            <div class="text-[11px] text-gray-400">Lịch dạy bù</div>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                ...
                <li class="dropdown ml-3">
                    ...
                    <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                        <li>
                            <a href="{{ route('ho-so') }}" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Hồ sơ</a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Cài đặt</a>
                        </li>
                        <li>
                            @if (Route::has('logout'))
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <a role="menuitem" href="route('logout')" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50 cursor-pointer"
